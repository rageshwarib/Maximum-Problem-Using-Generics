...
public class MaximumAnalyserTests {
    ...
    public void GivenThreeIntegers_findMaximumAtfirstPosition_shuldReturnSameNumber() {
        ...
        maximumAnalyser.printMaximum("Maximum Integer number: " +maximumNumber);
    ...
    public void GivenThreeFloat_findMaximumAt_firstPosition_shuldReturnSameNumber() {
        ...
        maximumAnalyser.printMaximum("Maximum Float number: " +maximumNumber);
    }
    @Test
    ...
    public void GivenThreeStrings_findMaximumAt_firstPosition_shuldReturnSameString() {
        String maximum = (String) maximumAnalyser.findMaximum("Peach" , "Apple" , "Banana", "Mango","Orange","Strawberry");
        Assert.assertEquals((String) "Strawberry" , maximum);
        maximumAnalyser.printMaximum("Maximum Element: " +maximum);
    }
    @Test
    public void GivenThreeStrings_findMaximumAt_secondPosition_shuldReturnSameString() {
        String maximum = (String) maximumAnalyser.findMaximum("Apple","Orange","Strawberry","Peach" ,"Banana");
        Assert.assertEquals((String) "Strawberry" , maximum);
        maximumAnalyser.printMaximum("Maximum Element: " +maximum);
    }
    @Test
    public void GivenThreeStrings_findMaximumAt_thirdPosition_shuldReturnSameString() {
        String maximum = (String) maximumAnalyser.findMaximum("Orange","Strawberry","Banana" ,"Apple", "Peach");
        Assert.assertEquals((String) "Strawberry" , maximum);
        maximumAnalyser.printMaximum("Maximum Element: " +maximum);
    }
